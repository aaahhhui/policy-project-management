      ...
      <table>
        ...
        <tbody>
          <tr v-for="source in sources" :key="source.id">
            ...
            <td>{{ source.latest_result ?? "尚无结果" }}</td>
            <td class="actions">
